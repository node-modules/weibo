...
var TSinaAPI = require('./lib/tsina.js');
...
var tapi = {
	...
	get_authorization_url: function(user, auth_callback, callback, context) {
		return this.api_dispatch(user).get_authorization_url(user, auth_callback, callback, context);
	},
	...
	upload: function(user, data, pic, callback, context){
		return this.api_dispatch(user).upload(user, data, pic, callback, context);
	},

    ...
    it('should handle no-acsii correct', function () {
      var cases = [
        ['【观点·@任志强】今年提出的1000万套的保障房任务可能根本完不成', 
         '【观点·<a class="at-user-link" href="http://weibo.com/n/%E4%BB%BB%E5%BF%97%E5%BC%BA">@任志强</a>】今年提出的1000万套的保障房任务可能根本完不成'],
        ['abc@foo@bar....!@#$', 
         'abc<a class="at-user-link" href="http://weibo.com/n/foo">@foo</a><a class="at-user-link" href="http://weibo.com/n/bar">@bar</a>....!@#$'],
      ];

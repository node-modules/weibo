...
var TSinaAPI = {
	...
	config: {
		...
		result_format: '.json',
		source: '1759110853',
        oauth_key: '1759110853',
        oauth_secret: 'fb2f52866dde46ac7dccda7b1a550324',
        // google app key
...
//    	user.authtype = user.authtype || 'oauth';
		...
		this.get_request_token(user, function(token, text_status, error_code) {
			...
			callback(login_url, text_status, error_code);
		}, this);
    },
...
//TSinaAPI.request('http://www.qq.com/', {}, function(data) {
//	console.log(data.length);
//});
//TSinaAPI.public_timeline(null, function(data) {
...
//	console.log(data);
//});
//var user = {username: 'bodianying@sina.cn', password: 'net4pass'};
//TSinaAPI.friends_timeline({user: user}, function(data) {
//	console.log(util.inspect(data[0]));
//});
//TSinaAPI.verify_credentials(user, function(data) {
//	data.created_at = new Date(data.created_at).format("yyyy-MM-dd hh:mm:ss");
//	console.log(new Date(data.created_at));
//	console.log(util.inspect(data));
//});

//TSinaAPI.update({user: user, status: 'testnodejs'}, function(data) {
//	console.log(util.inspect(data));
//});

//TSinaAPI.upload(user, {status: 'test pic upload 2'}, 
//	{
//		file: './mk2.jpg'
//	}, function(data) {
//		console.log(util.inspect(data));
